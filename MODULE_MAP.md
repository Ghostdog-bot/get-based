...
- [`js/ai-provider-policy.js`](js/ai-provider-policy.js) → [`js/agent-chat-settings.js`](js/agent-chat-settings.js), [`js/api-provider-storage.js`](js/api-provider-storage.js), [`js/local-ai-provider-shared.js`](js/local-ai-provider-shared.js)
...
<details><summary><code>app</code> family — 11 modules</summary>
...
- [`js/app-extension-runtime.js`](js/app-extension-runtime.js) → no in-scope imports
...
- [`js/biology-score-methodology.js`](js/biology-score-methodology.js) → no in-scope imports
- [`js/biology-score-panel-policy.js`](js/biology-score-panel-policy.js) → [`js/biology-score-contract.js`](js/biology-score-contract.js), [`js/biology-score-dates.js`](js/biology-score-dates.js), [`js/biology-score-inputs.js`](js/biology-score-inputs.js)
...
- [`js/chart-card-recs.js`](js/chart-card-recs.js) → [`js/marker-detail-modal.js`](js/marker-detail-modal.js), [`js/marker-placement.js`](js/marker-placement.js), [`js/recommendations-runtime.js`](js/recommendations-runtime.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/chat-prompt-context.js`](js/chat-prompt-context.js) → [`js/lab-context-settings.js`](js/lab-context-settings.js), [`js/lab-context.js`](js/lab-context.js)
...
<details><summary><code>data</code> family — 7 modules</summary>
...
- [`js/demo-biology-insights.js`](js/demo-biology-insights.js) → no in-scope imports
...
- [`js/main.js`](js/main.js) → [`js/app-extension-bootstrap.js`](js/app-extension-bootstrap.js), [`js/app-feature-modules.js`](js/app-feature-modules.js), [`js/shell-actions.js`](js/shell-actions.js), [`js/startup-orchestrator.js`](js/startup-orchestrator.js)
...
<details><summary><code>marker</code> family — 17 modules</summary>
...
<details><summary><code>mosaic</code> family — 1 module</summary>

- [`js/mosaic-oat-catalog.js`](js/mosaic-oat-catalog.js) → [`js/adapters.js`](js/adapters.js)
...
- [`js/proxy-runtime.js`](js/proxy-runtime.js) → [`js/url-safety.js`](js/url-safety.js)
...
- [`js/settings-agent-access-panel.js`](js/settings-agent-access-panel.js) → [`js/data.js`](js/data.js), [`js/profile-data-writes.js`](js/profile-data-writes.js), [`js/state.js`](js/state.js), [`js/sync.js`](js/sync.js), [`js/utils-runtime.js`](js/utils-runtime.js), [`js/utils.js`](js/utils.js)
...
- [`js/sun-uvdata.js`](js/sun-uvdata.js) → [`js/caught-error.js`](js/caught-error.js), [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/sun-runtime.js`](js/sun-runtime.js), [`js/sun-uvdata-atmosphere.js`](js/sun-uvdata-atmosphere.js), [`js/sun-uvdata-config.js`](js/sun-uvdata-config.js), [`js/url-safety.js`](js/url-safety.js)
...
<details><summary><code>sync</code> family — 76 modules</summary>
...
- [`js/sync-payload-collectors.js`](js/sync-payload-collectors.js) → [`js/app-extension-runtime.js`](js/app-extension-runtime.js), [`js/crypto.js`](js/crypto.js), [`js/voice-settings-schema.js`](js/voice-settings-schema.js)
- [`js/sync-payload.js`](js/sync-payload.js) → [`js/nutrition-sync-sanitize.js`](js/nutrition-sync-sanitize.js), [`js/sync-chat-merge.js`](js/sync-chat-merge.js) *(dynamic)*, [`js/sync-payload-codec.js`](js/sync-payload-codec.js), [`js/sync-payload-collectors.js`](js/sync-payload-collectors.js), [`js/sync-profile-fields.js`](js/sync-profile-fields.js)
- [`js/sync-profile-fields.js`](js/sync-profile-fields.js) → no in-scope imports
...
- [`js/sync-push.js`](js/sync-push.js) → [`js/caught-error.js`](js/caught-error.js), [`js/nutrition-sync-sanitize.js`](js/nutrition-sync-sanitize.js), [`js/profile-sync-policy.js`](js/profile-sync-policy.js), [`js/profile.js`](js/profile.js), [`js/sync-chat-merge.js`](js/sync-chat-merge.js) *(dynamic)*, [`js/sync-delta.js`](js/sync-delta.js), [`js/sync-dirty-state.js`](js/sync-dirty-state.js), [`js/sync-origin-state.js`](js/sync-origin-state.js), [`js/sync-payload.js`](js/sync-payload.js), [`js/sync-push-deltas.js`](js/sync-push-deltas.js), [`js/sync-relay-health.js`](js/sync-relay-health.js), [`js/sync-state.js`](js/sync-state.js)
...
<details><summary><code>unit</code> family — 1 module</summary>

- [`js/unit-profiles.js`](js/unit-profiles.js) → [`js/schema.js`](js/schema.js)
...
- [`js/wearables-disconnect-recovery.js`](js/wearables-disconnect-recovery.js) → [`js/data-merge.js`](js/data-merge.js), [`js/data.js`](js/data.js), [`js/wearables-store.js`](js/wearables-store.js)
- [`js/wearables-fitbit-auth.js`](js/wearables-fitbit-auth.js) → [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js), [`js/wearables-auth-runtime.js`](js/wearables-auth-runtime.js)
- [`js/wearables-fitbit.js`](js/wearables-fitbit.js) → [`js/caught-error.js`](js/caught-error.js), [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js)
- [`js/wearables-formatters.js`](js/wearables-formatters.js) → [`js/wearable-adapters.js`](js/wearable-adapters.js)
- [`js/wearables-google-health-auth.js`](js/wearables-google-health-auth.js) → [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js), [`js/wearables-auth-runtime.js`](js/wearables-auth-runtime.js)
...
- [`js/wearables-polar.js`](js/wearables-polar.js) → [`js/caught-error.js`](js/caught-error.js), [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js)
...
- [`js/wearables-whoop-auth.js`](js/wearables-whoop-auth.js) → [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js), [`js/wearables-auth-runtime.js`](js/wearables-auth-runtime.js)
- [`js/wearables-whoop-storage.js`](js/wearables-whoop-storage.js) → no in-scope imports
- [`js/wearables-whoop.js`](js/wearables-whoop.js) → [`js/caught-error.js`](js/caught-error.js), [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js)
- [`js/wearables-withings-auth.js`](js/wearables-withings-auth.js) → [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js), [`js/wearables-auth-runtime.js`](js/wearables-auth-runtime.js), [`js/wearables-withings.js`](js/wearables-withings.js)
- [`js/wearables-withings.js`](js/wearables-withings.js) → [`js/caught-error.js`](js/caught-error.js), [`js/proxy-runtime.js`](js/proxy-runtime.js), [`js/utils.js`](js/utils.js), [`js/wearables-oura.js`](js/wearables-oura.js)
...
## compat-server modules

Standalone Node compatibility-relay entry point.
